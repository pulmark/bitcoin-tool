 ...
 */
void Bitcoin_SHA256(struct BitcoinSHA256 *output, const void *input,
                    size_t size);
 ...
 *  @param[in] size Number of bytes of data at 'input' to hash.
 */
void Bitcoin_DoubleSHA256(struct BitcoinSHA256 *output, const void *input,
                          size_t size);
 ...
 *  @param[in] size Number of bytes of data at 'input' to hash.
 */
void Bitcoin_RIPEMD160(struct BitcoinRIPEMD160 *output, const void *input,
                       size_t size);
